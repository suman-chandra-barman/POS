...
import { SAMPLE_PRODUCTS } from "../data/discountMockData";
import { cn } from "@/lib/utils";

interface DiscountProductSelectorProps {
  selectedProducts: SelectedTagItem[];
  onChange: (products: SelectedTagItem[]) => void;
  className?: string;
}

export const DiscountProductSelector: React.FC<
  DiscountProductSelectorProps
> = ({ selectedProducts, onChange, className }) => {
  ...
  const handleToggleProduct = (product: SelectedTagItem) => {
