          ...
          <div className="relative">
            <button
              ...
              className={cn(
                ...
                activeMenu === "options" && "bg-neutral-100 text-neutral-900"
              )}
            >
              <span>Options</span>
            ...
            {activeMenu === "options" && (
              <>
                ...
                />
                <div className="absolute left-0 top-full mt-1 w-44 bg-white rounded-xl shadow-lg border border-neutral-200 py-1.5 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                  <button
                    type="button"
                    onClick={() => setActiveMenu(null)}
