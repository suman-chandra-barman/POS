...
export const AuthLayout: React.FC<AuthLayoutProps> = ({
  ...
  return (
    <div
      className={cn(
        "theme-auth relative min-h-screen w-full flex items-center justify-center p-4 sm:p-6 md:p-8 bg-[#f2f2f2] overflow-hidden select-none",
        className
      )}
    >
      {/* Left Decorative Ribbon/Chevron Background Image */}
      <div className="pointer-events-none absolute left-0 -top-6 sm:-top-8 md:-top-9 w-[17vw] min-w-36 max-w-65 h-auto select-none z-0">
        <Image
          ...
          alt="Auth background left pattern"
          width={249}
          height={282}
          priority
      ...
      {/* Right Decorative G-Shape Background Image */}
      <div className="pointer-events-none absolute -right-3 sm:-right-4 md:-right-5 -bottom-3 sm:-bottom-4 md:-bottom-5 h-[91vh] max-h-230 w-[39vw] min-w-75 max-w-160 flex items-end justify-end select-none z-0">
        <Image
          ...
          alt="Auth background right pattern"
          width={492}
          height={704}
          priority
