...
export const SetupHeaderBox: React.FC<SetupHeaderBoxProps> = ({
  ...
  return (
    <div className="w-full rounded-2xl bg-[#f4f4f6] px-4 py-2.5 sm:px-5 sm:py-3 text-center">
      <h2 className="text-sm sm:text-[14.5px] font-semibold tracking-tight text-neutral-900">
        {title}
      </h2>
